...
class AuditLogger:
    ...
    def log_event(
        ...
        resource_str = resource or "N/A"
        log_message = (
            f"USER:{user_str} ACTION:{action} "
            f"RESOURCE:{resource_str} SUCCESS:{success}"
        )
        if details:
    ...
    def log_file_access(
        self, username: str, filename: str, action: str, success: bool = True
    ) -> None:
    ...
    def log_password_change(self, username: str, success: bool) -> None:
    ...
    def log_user_creation(self, username: str, created_by: str, success: bool) -> None:
        """Log user creation"""
        self.log_event(
            username=created_by,
