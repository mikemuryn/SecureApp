...
from app.auth.authentication import AuthenticationManager  # noqa: F401
from app.auth.session_manager import SessionManager  # noqa: F401
from app.encryption.file_crypto import FileEncryption  # noqa: F401
from app.models.database import DatabaseManager, SecureFile, User  # noqa: F401
from app.utils.audit_logger import AuditLogger  # noqa: F401
from app.utils.file_manager import FileAccessManager  # noqa: F401
...
class TestSessionManager:
    ...
    def test_session_expiration(self, session_manager):
        ...
        session_manager.sessions[session.session_id].expires_at = (
            session_manager.sessions[session.session_id].expires_at.replace(year=2020)
        )
